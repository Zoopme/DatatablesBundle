...
class Options
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setAllowedValues('global_search_type', ['like', 'keywords_string', 'keywords_string_phone', '%like', 'like%', 'notLike', 'eq', 'neq', 'lt', 'lte', 'gt', 'gte', 'in', 'notIn', 'isNull', 'isNotNull']);
